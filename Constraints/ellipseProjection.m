...
function out = ellipseProjection(focus,a,point,varargin)
...
function dtdx = Dtdx(a,b,v,t,~,focus,H,z,v_n)
    %get this through dGdx=0
    dv_p0dx = Dv_nDx(H,z,focus,v_n,1);
    dv_p1dx = Dv_nDx(H,z,focus,v_n,2);
    dbdx = -[(focus(1,1)-focus(1,2)),(focus(2,1)-focus(2,2)),(focus(1,2)-focus(1,1)),(focus(2,2)-focus(2,1))]/(4*b);
